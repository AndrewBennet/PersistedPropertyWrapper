...
@propertyWrapper
public struct PersistedValue<Exposed, NonOptionalExposed, Convertor> where Convertor: PersistedStorageConvertor,
    ...
    /// The UserDefaults to read and write from and to.

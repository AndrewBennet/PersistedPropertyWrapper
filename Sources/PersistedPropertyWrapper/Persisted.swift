...
/// If you wish to use a persisted value in code outside of SwiftUI, or in code not on the Main Actor, use `@PersistedValue` instead, which is a simpler
/// and more lightweight wrapper around `UserDefaults`.
@MainActor
@propertyWrapper
public struct Persisted<Exposed, NonOptionalExposed, Convertor>: DynamicProperty where Convertor: PersistedStorageConvertor,
